...
// drag-to-reschedule (wayfinder tickets 07 + 09,
...
// (ticket 04). Dragging a bar's body persists a per-placement start-date
// override (ticket 09), autosaving on drop with no separate Save button -
// leave/holiday shading and Dev/QA bar linking are ticket 08's independent
// scope, built on top of this same task-tree shape.
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Hides each synthetic person-row's own summary bar - only its grid
          ...
          this just also keeps the hidden summary bar out of reach). */}
