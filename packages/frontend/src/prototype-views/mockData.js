...
export const categoryCounts = (categoryId) => {
...
export const isDueToday = (dueDate) => dueDate === TODAY_ISO

export const priorityOrder = { High: 0, Medium: 1, Low: 2 }
export const priorityColor = { High: '#e63946', Medium: '#f4a261', Low: '#2a9d8f' }
